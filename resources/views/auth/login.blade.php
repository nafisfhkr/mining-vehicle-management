<x-guest-layout>
    <div class="mb-4 text-center">
        ...
        <p class="text-sm text-gray-500">Sistem Monitoring Kendaraan Tambang</p>
    </div>
    ...
    <form method="POST" action="{{ route('login') }}">
        ...
        <div class="flex items-center justify-end mt-4">
            ...
            <x-primary-button class="ms-3 bg-indigo-600 hover:bg-indigo-700 focus:bg-indigo-700 active:bg-indigo-900">
                {{ __('Masuk') }}
            </x-primary-button>
        </div>
    </form>
